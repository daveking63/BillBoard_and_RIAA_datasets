...
The combination of txt files will first be used to: (1) illustrate the feature and functions of "pandas" (see <a href= 'https://github.com/daveking63/Jupyter-iPython-Notebooks/blob/readme.md'><i>Jupyter iPython Notebooks</i></a> in one of my other repositories) and (2) subsequently used in another entry in this repository to highlight and summarize some of changes that have occurred in the music industry over the last 60 years.
